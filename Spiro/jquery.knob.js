        ...
        return this.each(
                    ...
                    function() {
                        ...
                        if( !opt.readOnly ){
                            ...
                            // input
                            var kval,val,to,tocb,m=1,kv={37:-1*opt.increment,38:1*opt.increment,39:1*opt.increment,40:-1*opt.increment}
                            $this.bind(
                                            "keydown"
                                            ,function(e) {
                                                var kc = e.keyCode;
    ...
    Dial = function( c, opt ) {
        ...
        this.val = function(_v) {
            if(null!=_v){
                ...
                (a<0) && (b=a+PI2);
				// GM: CHANGE TO SUPPORT INC
                 //_v = Math.round( b*(opt.max-opt.min)/PI2 ) + opt.min;
				 _v = (Math.round( (1/opt.increment) * b*(opt.max-opt.min)/PI2 ) * (opt.increment)) + opt.min;
